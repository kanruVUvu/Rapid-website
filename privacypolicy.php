...
<html lang="en">
    <head>
        ...
        <title>Rapid Website PrivacyPolicy Page</title>
    ...
    font-weight: 500;
		...
		.header {
    width: 100%;
    background-image:url("assets/img/privacypolicy.png");
    height: auto;
   min-height: 526px;
	position:relative;
	top:80px;
...
.header {
   ...
   <header id="home" class="header">
	...
	<a href="index.php" style="text-decoration:none;color: #CE202F;" id="imageheader">PREMIER LOTTERY</a>
            <div class="nav-items">
                <a href="aboutus.php" class="nav-item active" aria-current="page" style="text-decoration:underline;color:#CE202F;text-decoration-color: #1F3D7B;">ABOUT</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <br>
  <br>
  <input type="hidden" name="taskjbc" value="add">
...
<div class="modal fade" id="myModal2" role="dialog">
  ...
  <input type="hidden" name="taskvqc" value="add">
        <div class="modal-footer">
		<div class="form-group">
...
<br>
<div class="con4">
<h3 id="question">Privacy Policy</h3>
<br>
<div class="mnq">We use first party cookies to collect information about how the website is used. For example, time of visit, duration of visit, methods used to<br> access the website, and pages viewed.<br><br>Third-party Google cookies are used to enable remarketing and reporting for impression assisted visits, website conversions, user<br> demographics, and user interests.<br><br>Users can opt out of interest-based ads by Google through ads settings: www.google.com/settings/ads<br><br>Website visitors can opt out of the Google Analytics Advertising Features by downloading a browser add-on:<br>https://tools.google.com/dlpage/gaoptout/.<br><br>West Perth Football Club Inc. collects personal information as a part of its fundraising activities, to assist us in complying with our legal and<br> regulatory obligations and for other related purposes. By providing any personal information to us and/or being involved in our fundraising<br> activities you consent to the collection of the personal information and the use and disclosure of that information in the manner set out in<br> our privacy policy.<br><br> Please refer to the privacy policy on our website at https://www.xxxx/privacy-policy for information about how we collect, use and disclose <br>your personal information and your rights in relation to it. If you do not have access to the internet, we will gladly send you a copy of our<br>privacy policy.</div>
<br>
</div>
<br>
<br>
...
<footer class="bg-light3 text-center text-lg-start" style="background:#CE202F;">
  <!-- Grid container -->
...
<footer class="bg-light2 text-center text-lg-start" style="background-color:#1F3D7B;">
  <!-- Grid container -->
